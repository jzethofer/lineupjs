import type { Column, Ranking, IColumnConstructor, IColumnDesc, IGroup, IndicesArray, IDataRow, IRankingDump, EAggregationState, IColorMappingFunctionConstructor, IMappingFunctionConstructor, ITypeFactory } from '../model';
...
export declare const SCHEMA_REF = "https://lineup.js.org/develop/schema.4.0.0.json";
