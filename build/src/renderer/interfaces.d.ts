...
import type { Column, IDataRow, IOrderedGroup, INumberColumn, ICategoricalLikeColumn, IDateColumn, StringColumn } from '../model';
import type { IDataProvider } from '../provider';
import type DialogManager from '../ui/dialogs/DialogManager';
import type { ISequence, IDateStatistics, ICategoricalStatistics, IAdvancedBoxPlotData, IStatistics, IStringStatistics } from '../internal';
...
export interface IRenderTasks {
    ...
    summaryBoxPlotStats(col: Column & INumberColumn, raw?: boolean): IRenderTask<{
        summary: IAdvancedBoxPlotData;
        data: IAdvancedBoxPlotData;
    }>;
    summaryNumberStats(col: Column & INumberColumn, raw?: boolean): IRenderTask<{
        summary: IStatistics;
        data: IStatistics;
    }>;
    summaryCategoricalStats(col: Column & ICategoricalLikeColumn): IRenderTask<{
        summary: ICategoricalStatistics;
        data: ICategoricalStatistics;
    }>;
    summaryDateStats(col: Column & IDateColumn): IRenderTask<{
        summary: IDateStatistics;
        data: IDateStatistics;
    }>;
    summaryStringStats(col: StringColumn): IRenderTask<{
        summary: IStringStatistics;
        data: IStringStatistics;
    }>;
}
