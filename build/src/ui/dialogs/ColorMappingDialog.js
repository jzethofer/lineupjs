...
function toColor(input, node) {
    switch (input.value) {
        ...
        case 'custom:divergent':
            var dm1 = node.querySelector('input[name=divergingm1]').value;
            var d0 = node.querySelector('input[name=diverging0]').value;
            var d1 = node.querySelector('input[name=diverging1]').value;
            return new CustomColorMappingFunction([
                { color: dm1, value: 0 },
                { color: d0, value: 0.5 },
                { color: d1, value: 1 },
